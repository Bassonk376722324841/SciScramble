...
class StartQuiz:
    ...
    def add_placeholder(self, event=None):
        if not self.num_rounds_entry.get():
            self.num_rounds_entry.insert(0, "Number of rounds")
            self.num_rounds_entry.fg = "grey"

    def clear_placeholder(self, event=None):
        if self.num_rounds_entry.fg == "grey" and self.num_rounds_entry.get() == "Number of rounds":
    ...
    def get_actual_value(self):
        ...
        if self.num_rounds_entry.fg == "grey":
            return ''
