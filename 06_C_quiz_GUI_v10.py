...
class Play:
    ...
    def new_round(self):
        ...
        if self.played and self.rounds_played != rounds_wanted:
        ...
        elif self.played == True and self.rounds_played == rounds_wanted:
        ...
        if len(answer.strip()) == 0 and not self.played:
