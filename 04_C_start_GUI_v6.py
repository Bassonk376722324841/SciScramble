...
class StartQuiz:
    ...
    def __init__(self):
        ...
        start_labels_list = [
            ...
            [round_string, ("Arial", "11", "bold"), "grey"]
        ]
        ...
        difficulty_label = Label(self.start_frame, text="difficulty:", font="Arial",
                           fg="grey", wraplength=350, justify="left", padx=20, pady=10)
        difficulty_label.grid(row=4)

        # Create master window and create string variable
        # in order to store any string value
        ...
        self.entry_area_frame.grid(row=5)
